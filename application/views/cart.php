...
<tr class="first last odd">
    <td class="image hidden-table"><a href="<?php echo base_url('product_details');?>" title="Women&#39;s Georgette Animal Print" class="product-image"><img src="<?php echo base_url();?>images/p8.jpg" width="75" alt="Women&#39;s Georgette Animal Print"></a></td>
    <td>
        <h2 class="product-name">
                    <a href="<?php echo base_url('product_details');?>">Women's Georgette Animal Print</a>
                </h2>
                                                        </td>
...
<tr class="odd">
    <td class="image hidden-table"><a href="<?php echo base_url('product_details');?>" title="Women&#39;s Georgette Animal Print" class="product-image"><img src="<?php echo base_url();?>images/p3.jpg" width="75" alt="Women&#39;s Georgette Animal Print"></a></td>
    <td>
        <h2 class="product-name">
                    <a href="<?php echo base_url('product_details');?>">Women's Georgette Animal Print</a>
                </h2>
...
<tr class="odd">
    <td class="image hidden-table"><a href="<?php echo base_url('product_details');?>" title="Women&#39;s Georgette Animal Print" class="product-image"><img src="<?php echo base_url();?>images/p1.jpg" width="75" alt="Women&#39;s Georgette Animal Print"></a></td>
    <td>
        <h2 class="product-name">
                    <a href="<?php echo base_url('product_details');?>">Women's Georgette Animal Print</a>
                </h2>
...
<tr class="last">
    <td class="image hidden-table"><a href="<?php echo base_url('product_details');?>" title="Women&#39;s Georgette Animal Print" class="product-image"><img src="<?php echo base_url();?>images/p2.jpg" width="75" alt="Women&#39;s Georgette Animal Print"></a></td>
    <td>
        <h2 class="product-name">
                    <a href="<?php echo base_url('product_details');?>">Women's Georgette Animal Print</a>
                </h2>
