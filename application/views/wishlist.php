      ...
      <div class="row">
                  ...
                  <table class="clean-table linearize-table data-table table-striped" id="wishlist-table">
                    ...
                    <tbody>
                      <tr id="item_32" class="first odd">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Slim Fit Casual Shirt"> <img src="<?php echo base_url();?>images/p2.jpg" width="80" height="80" alt="Slim Fit Casual Shirt"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Slim Fit Casual Shirt">Slim Fit Casual Shirt</a></h3>
                          ...
                          <textarea style="height: 120px; width: 96%;" name="description[32]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                      ...
                      <tr id="item_34" class="even">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Vivante Gorgeous Cotton"> <img src="<?php echo base_url();?>images/p4.jpg" width="80" height="80" alt="Vivante Gorgeous Cotton"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Vivante Gorgeous Cotton">Vivante Gorgeous Cotton</a></h3>
                          <div class="description std">
                            <div class="inner">Here are six crochet patterns for boutique beauty on a budget. These lovely looks are created by uber-hip designer Afya Ibomu, famed for her roster of hip-hop star customers and fans.</div>
                          </div>
                          <textarea style="height: 120px; width: 96%;" name="description[34]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
                      ...
                      <tr id="item_65" class="odd">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Kalia Bumblebee Black"> <img src="<?php echo base_url();?>images/p3.jpg" width="80" height="80" alt="Kalia Bumblebee Black"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Kalia Bumblebee Black">Kalia Bumblebee Black</a></h3>
                          <div class="description std">
                            <div class="inner">Transformers inspired and Camaro Infused. This Tshirt just rocks for those huge Autobots and Decepticons Fans.</div>
                          </div>
                          <textarea style="height: 120px; width: 96%;" name="description[65]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
                      ...
                      <tr id="item_66" class="even">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Micromax X101i"> <img src="<?php echo base_url();?>images/p8.jpg" width="80" height="80" alt="Micromax X101i"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Micromax X101i">Micromax X101i</a></h3>
                          <div class="description std">
                            <div class="inner">Memory expandable up to 4GB and active dual SIM (GSM + GSM), 1000mAH battery providing talk-time of 4 hours and standby time of 200 hours on 2G network, 1 year manufacturer warranty for device and 6 months manufacturer warranty for in-box accessories including batteries from the date of purchase.</div>
                          </div>
                          <textarea style="height: 120px; width: 96%;" name="description[66]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
                      ...
                      <tr id="item_69" class="odd">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Softwear Women&#39;s Designer"> <img src="<?php echo base_url();?>images/p5.jpg" width="80" height="80" alt="Softwear Women&#39;s Designer"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Softwear Women&#39;s Designer">Softwear Women's Designer</a></h3>
                          <div class="description std">
                            <div class="inner">Casual wear, Normal Machine Wash. A Black Multi-Coloured Printed Leggings for Women from Softwear. Made from Cotton and Lycra, this Leggings features Full Length, Designer printed , Casual wear, Normal Machine Wash.</div>
                          </div>
                          <textarea style="height: 120px; width: 96%;" name="description[69]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
                      ...
                      <tr id="item_88" class="even">
                        <td class="wishlist-cell0 customer-wishlist-item-image"><a class="product-image" href="product-detail.html" title="Softwear Women&#39;s Designer"> <img src="<?php echo base_url();?>images/p3.jpg" width="80" height="80" alt="Softwear Women&#39;s Designer"> </a></td>
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Softwear Women&#39;s Designer">Softwear Women's Designer</a></h3>
                          <div class="description std">
                          ...
                          <textarea style="height: 120px; width: 96%;" name="description[88]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
                      ...
                      <tr id="item_89" class="last odd">
                        ...
                        <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a href="product-detail.html" title="Slim Fit Casual Shirt">Slim Fit Casual Shirt</a></h3>
                          ...
                          <textarea style="height: 120px; width: 96%;" name="description[89]" rows="3" cols="5" onFocus="focusComment(this)" onBlur="focusComment(this)" title="Comment"></textarea></td>
                        <td class="wishlist-cell2 customer-wishlist-item-quantity" data-rwd-label="Quantity"><div class="cart-cell">
                            <div class="add-to-cart-alt">
        ...
        <aside class="col-right sidebar col-sm-3 col-xs-12 wow bounceInUp animated animated" style="visibility: visible;">
          ...
          <div class="custom-slider">
			...
			<div class="item active"> <img src="<?php echo base_url();?>images/slide3.jpg" alt="...">
                <div class="carousel-caption">
                  <h3><a href="product-detail.html" title=" Sample Product">50% OFF</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
				  <a href="#" class="link">Buy Now</a>                </div>
              </div>
              <div class="item"> <img src="<?php echo base_url();?>images/slide1.jpg" alt="...">
                <div class="carousel-caption">
                  <h3><a href="product-detail.html" title=" Sample Product">Hot collection</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
              </div>
              <div class="item"> <img src="<?php echo base_url();?>images/slide2.jpg" alt="...">
                <div class="carousel-caption">
                  <h3><a href="product-detail.html" title=" Sample Product">Summer collection</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
              </div>
